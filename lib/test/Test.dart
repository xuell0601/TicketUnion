// typedef sucess = void Function(String string);
// typedef fiade = void Function(Exception e);
//
// class Test {
//   sucess s;
//   fiade f;
//
//   Test({fiade this.f, sucess this.s});
// }
//
// class Client {
//   bool isTrue = true;
//
//   void setCallback(Test test) {
//     if (isTrue) {
//       test.s("ASJ");
//     } else {
//       //test.f(e);
...
// void Mian() {
//   new Client()
//       .setCallback(Test(s: (String st) {}, f: (Exception exception) {}));
// }
//
