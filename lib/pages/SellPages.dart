...
class SellPagesState extends State<SellPages> with AutomaticKeepAliveClientMixin{
   int pages=0;
  ...
  void initState() {
    ...
    getContent(Config.sell,page:pages).then((data){
        setState(() {
              ...
              sellList=  sellModel.data.tbkDgOptimusMaterialResponse.resultList.mapData;
              pages++;
               ...
               child: Column(
                 children: [
                   ...
                   Row(children: <Widget>[
                     ...
                     Expanded(child: Text("¥${item.couponStartFee}",
                       style: TextStyle(
                           color: Colors.red,
                     ...
                     Expanded(
                       child:Text("卷后价:¥${item.couponAmount}",
                         style: TextStyle(
                             color: Colors.red
                         ),
